...
TEST(Mechanism, SU_Fixed_Frames) { // NOLINT
    ...
    std::vector<DualFrame> frames = {
            ...
            DualFrame(RotationMatrix(M_PI_4,0,0), PointVector(0,0,-5)),
            DualFrame(RotationMatrix(0,M_PI_4,0), PointVector(0,0,-5)),
            DualFrame(RotationMatrix(0,0,M_PI_4), PointVector(0,0,-5)),
            DualFrame(RotationMatrix(M_PI_2,M_PI_2,0), PointVector(0,0,-5)),
            DualFrame(RotationMatrix(M_PI_4,M_PI_4,M_PI_4), PointVector(0,0,-5)),
